...
const NewStatementModal = ({ isOpen, onClose, onCreate }) => {
    ...
    const periodData = useMemo(() => {
        ...
        // Validation for Pro Forma (Must be future)
        const isFuture = start > new Date(); // Simple check against "now" (or Dec 2025 per context)
        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-xl shadow-2xl max-w-2xl w-full flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-white">
                    <div>
                        <h2 className="text-xl font-bold text-slate-800">Create New Financial Statement</h2>
                ...
                <div className="bg-slate-50 p-6 border-t border-slate-200">
                    <div className="flex justify-between items-center">
                        <div className="text-xs text-slate-400 font-medium hidden sm:block">
                            * Statement will be created as Draft
                        </div>

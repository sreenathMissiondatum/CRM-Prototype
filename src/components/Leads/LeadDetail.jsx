...
const LeadDetail = ({ lead, onBack, onViewAccount, onViewContact }) => {
    ...
    const handleLogActivity = (newActivity) => {
        ...
        const activityRecord = {
            ...
            timestamp: 'Just now',
            date: 'Today',
            summary: newActivity.notes || `Logged ${newActivity.outcome} call`,
                            ...
                            <div className="flex items-center gap-3 mb-1">
                                ...
                                <div>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${lead.stage === 'Qualified' ? 'bg-emerald-100 text-emerald-700' :
